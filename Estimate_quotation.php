        ...
        <div class="container">
          <div class="col-md-12">
            <div class="text-center">
              ...
              <p class="pt-0 font-weight-bold h3">Estimate/Quotation</p>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-4 d-flex">
              <ul class="list-unstyled ml-auto">
                <li class=""><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span class="fw-bold">DOS/E </span>#123-456
                </li>
                <li class=""><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span class="fw-bold">Vendor #</span>
                  30140453</li>
                ...
                <li class=""><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span class="fw-bold">A/C No #</span>
